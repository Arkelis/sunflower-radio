...
def test_get_cover_from_deezer_with_deezertrack():
    ...
    assert link == "https://deezer.com/album/207861892"
    assert cover == "https://e-cdns-images.dzcdn.net/images/cover/b2284e22177a46ed3029dc91ea95d4e8/500x500-000000-80-0-0.jpg"


def test_get_cover_from_deezer_with_artist():
    cover, link = fetch_cover_and_link_on_deezer("backup", "LP")

    assert link == "https://deezer.com/artist/112259"
    assert cover == "https://e-cdns-images.dzcdn.net/images/artist/42a2ef16887e2cd54b07b848fdfd9619/500x500-000000-80-0-0.jpg"
